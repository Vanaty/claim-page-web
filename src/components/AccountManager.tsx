...
const AccountManager: React.FC<AccountManagerProps> = ({ 
  ...
  return (
    <div>
      ...
      {/* Add Account Form with Animation */}
      <AnimatePresence>
        {showAddForm && (
          <motion.div
          ...
          >
            ...
            <div className="p-6">
              <h3 className="text-xl font-semibold mb-4">Nouveau compte TronPick</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <div>
                    ...
                    <input
                      ...
                      required
                    />
                    <small className="text-slate-500 text-xs mt-1 block">Adresse email associée à votre compte TronPick</small>
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      required
                    />
                    <small className="text-slate-500 text-xs mt-1 block">Clé privée pour l'auto-claim</small>
                  </div>
                  
                  <div>
                    <label className="form-label">Attente avant réclamation (min:sec) *</label>
                    <input
                      type="text"
                      ...
                      required
                    />
                    <small className="text-slate-500 text-xs mt-1 block">Heure d'attente avant la prochaine réclamation</small>
                  </div>
                ...
                <div className="grid grid-cols-3 gap-2 text-center">
                  ...
                  <div className="p-2 bg-slate-50 rounded-lg">
                    <div className="text-xs text-slate-600">
                      {new Date(account.addedAt).toLocaleDateString('fr-FR')}
                    </div>
                    <small className="text-slate-500 text-xs">Date</small>
                  </div>
                </div>
              </div>
            </motion.div>
