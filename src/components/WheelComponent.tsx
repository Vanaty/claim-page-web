...
const WheelComponent = ({
    ...
    const onTimerTick = () => {
        ...
        if (duration < upTime) {
            ...
            if (winningSegment) {
                // Ensure minimum spin time before considering stopping on winning segment
                const minSpinTime = upTime + downTime * 0.7 // At least 70% of down time
                if (currentSegment === winningSegment && duration > minSpinTime) {
                    progress = 1
                    angleDelta = 0
                } else {
